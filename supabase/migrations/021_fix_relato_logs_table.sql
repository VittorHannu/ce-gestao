-- Remove a tabela relato_logs se ela já existir (para corrigir o tipo de dado)
DROP TABLE IF EXISTS public.relato_logs;

-- Tabela para armazenar o histórico de alterações dos relatos
CREATE TABLE public.relato_logs (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    relato_id UUID NOT NULL REFERENCES public.relatos(id) ON DELETE CASCADE, -- CORRIGIDO: Agora é UUID
