...
CREATE OR REPLACE FUNCTION "public"."search_relatos_unaccented"("p_search_term" "text" DEFAULT ''::"text", "p_status_filter" "text" DEFAULT NULL::"text", "p_responsible_filter" "text" DEFAULT 'all'::"text") RETURNS SETOF "public"."relatos"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."search_relatos_unaccented"("p_search_term" "text", "p_status_filter" "text", "p_responsible_filter" "text") OWNER TO "postgres";
...
CREATE POLICY "Allow authenticated users to create relatos" ON "public"."relatos" FOR INSERT TO "authenticated" WITH CHECK (true);
...
GRANT ALL ON FUNCTION "public"."search_relatos_unaccented"("p_search_term" "text", "p_status_filter" "text", "p_responsible_filter" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."search_relatos_unaccented"("p_search_term" "text", "p_status_filter" "text", "p_responsible_filter" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_relatos_unaccented"("p_search_term" "text", "p_status_filter" "text", "p_responsible_filter" "text") TO "service_role";
