...
export const getAllUsers = async () => {
  const { data, error } = await supabase
    .from('profiles')
    .select('id, email, full_name, is_active, can_view_users, can_create_users, can_update_users, can_delete_users, can_view_relatos, can_create_relatos, can_edit_relatos, can_delete_relatos')
