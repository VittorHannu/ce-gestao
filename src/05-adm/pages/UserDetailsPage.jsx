    ...
    const fetchUser = async () => {
      try {
        ...
        setEditedPermissions({
          ...
          can_update_users: data.can_update_users,
          can_delete_users: data.can_delete_users,
          can_view_relatos: data.can_view_relatos,
          can_create_relatos: data.can_create_relatos,
          can_edit_relatos: data.can_edit_relatos,
