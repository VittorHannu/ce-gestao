...
import { Dialog, DialogContent, DialogFooter, DialogHeader, DialogTitle, DialogTrigger } from '@/01-shared/components/ui/dialog';
...
export const EditableStatusField = ({ label, fieldKey, value, onFieldChange, isDirty, originalValue, canManage }) => {
  const [isEditing, setIsEditing] = useState(false);
...
const CompleteRelatoActions = ({ missingFields = [], editedFields, onFieldChange, isDirty, originalRelato, canManageRelatos }) => {
