...
const RelatoConfirmationPage = () => {
  console.log('--- Rendering RelatoConfirmationPage ---');
  ...
  if (!submissionData || !submissionData.relatoData) {
    console.log('No submissionData or relatoData found, rendering fallback.');
    return (
      <PublicLayout>
  ...
  console.log('Is the report anonymous?:', isReportAnonymous);
  ...
  const layoutProps = isAuthenticated ? { _user: context.user } : {};

  console.log('Using Layout:', Layout === MainLayout ? 'MainLayout' : 'PublicLayout');
  console.log('Passing these props to Layout:', layoutProps);
